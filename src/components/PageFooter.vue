<template>
    <!-- Sección 5 -->
    <div class="seccion-footer" id="footer" >

        <footer class="footer page-footer bg-secondary text-white pt-4">
            ...
            <!-- Footer Text -->
            <!-- Copyright -->
            <div class="footer-copyright text-center py-1 bg-dark">(c) 2020 Copyright
            </div>
            <!-- Copyright -->
