<template>
  ...
  <div class="seccion-superior">
    <header class="header">
      <div class="barra">
        <nav
          class="contenedor-menu navbar navbar-expand-lg sticky-top navbar-dark bg-dark"
        >
          <div class="titulo-principal">
            <a class="bg-dark w-100 navbar-brand" href="# ">
              <img
                src="../assets/icon.jpg"
                width="30 "
                height="30
          ...
          <div
            ...
            id="navbarNav "
          >
            <ul class="menu-principal navbar-nav">
  ...
  data() {
    return {
      items: [
        ...
        {
          src: "https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
        },
        {
          src: "https://images.unsplash.com/photo-1506399558188-acca6f8cbf41?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1439&q=80",
        },
      ],
    };
  },
